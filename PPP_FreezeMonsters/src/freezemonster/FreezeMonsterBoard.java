...
public class FreezeMonsterBoard extends AbstractBoard{
    ...
    protected void createBadSprites() {
        ...
        for (int k = 0; k < numMonstros; k++) {
            String path = "C:/Aulas/PPP/PPP_FreezeMonsters/images/monster" + (k + 1) + ".png";
            String path2 = "C:/Aulas/PPP/PPP_FreezeMonsters/images/monster" + (k + 1) + "bg.png";
            lastTime[k] = 0;
    ...
    protected void updateOtherSprites() {
        ...
        for (BadSprite monstro : badSprites) {
            ...
            if (!gosma.isDestroyed()) {
                ...
                if (gosma.getY() >= Commons.GROUND - Commons.TIRO_HEIGHT || gosma.getY() <= 5 || gosma.getX() > Commons.BOARD_WIDTH - 50 || gosma.getX() <= 5) {
                    gosma.setDestroyed(true);
                    Random rand = new Random();
